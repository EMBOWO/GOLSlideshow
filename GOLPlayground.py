...
RULES = ['B0123478/S01234678', 'B0123478/S34678', 'B01245/S01245', 'B01356/S012345', 'B014/S2', 'B017/S01', 'B026/S1', 'B028/S0124', 'B08/S4', 'B1/S012345678', 'B1/S014567', 'B1/S1', 'B1/S134567', 'B12678/S15678', 'B1357/S1357', 'B1357/S02468', 'B1358/S0247', 'B2/S', 'B2/S0', 'B2/S13', 'B2/S2345', 'B2/S23456', 'B2/S2345678', 'B234/S', 'B25/S4', 'B25678/S5678', 'B3/S012345678', 'B3/S023', 'B3/S0248', 'B3/S12', 'B3/S1234', 'B3/S12345', 'B3/S123678', 'B3/S1237', 'B3/S124', 'B3/S128', 'B3/S13', 'B3/S2', 'B3/S23', 'B3/S2378', 'B3/S238', 'B3/S245678', 'B3/S4567', 'B3/S45678', 'B34/S34', 'B34/S35', 'B34/S456', 'B345/S0456', 'B345/S2', 'B345/S4567', 'B345/S5', 'B34568/S15678', 'B3457/S4568', 'B34578/S456', 'B35/S23', 'B35/S234578', 'B35/S236', 'B3567/S15678', 'B35678/S34567', 'B35678/S4678', 'B35678/S5678', 'B357/S1358', 'B357/S238', 'B3578/S24678', 'B36/S12', 'B36/S125', 'B36/S128', 'B36/S23', 'B36/S234578', 'B36/S235', 'B36/S238', 'B36/S245', 'B367/S125678', 'B367/S23', 'B3678/S1258', 'B3678/S135678', 'B3678/S23', 'B3678/S235678', 'B3678/S34678', 'B368/S12578', 'B368/S128', 'B368/S236', 'B368/S238', 'B368/S245', 'B37/S012345678', 'B37/S12', 'B37/S1234', 'B37/S12345', 'B37/S23', 'B378/S012345678', 'B378/S235678', 'B38/S012345678', 'B38/S12', 'B38/S128', 'B38/S23', 'B38/S238', 'B45/S12345', 'B45/S1235', 'B45678/S2345', 'B45678/S5678', 'B4678/S35678', 'B48/S234', 'B56/S14568', 'B5678/S45678']

NAMES = ['AntiLife', 'InverseLife', 'B01245/S01245', 'Wickstretcher And The Parasites[1]', 'Oils', 'B017/S01', 'B026/S1', 'Invertamaze', 'Neon Blobs', 'H-trees', 'Fuzz', 'Gnarl', 'Snakeskin', 'Solid islands grow amongst static', 'Replicator', 'Fredkin', 'Feux', 'Seeds', 'Live Free or Die', 'B2/S13', 'B2/S2345', 'B2/S23456', 'B2/S2345678', 'Serviettes[5]', 'B25/S4', 'Iceballs', 'Life without death', 'DotLife', 'Star Trek', 'Flock', 'Mazectric', 'Maze', 'Magnezones', 'SnowLife', 'Corrosion of Conformity', 'EightFlock', 'LowLife', 'B3/S2', "Conway's Life", 'B3/S2378', 'EightLife', 'Shoots and Roots', 'Lifeguard 2', 'Coral', '3-4 Life', 'Dance', 'Bacteria[6]', 'Never happy', 'Blinkers', 'Assimilation', 'Long Life', 'Spiral and polygonal growth', 'Gems', 'Gems Minor', 'Grounded Life', 'Land Rush', 'B35/S236', 'Bugs[6]', 'Cheerios', 'Holstein[9]', 'Diamoeba', 'Amoeba', 'Pseudo Life', 'Geology', 'HighFlock', '2×2', 'IronFlock', 'HighLife', 'Land Rush 2', 'Virus', 'IronLife', 'sqrt replicator rule', 'Slow Blob', 'DrighLife', '2×2 2', 'Castles', 'B3678/S23', 'Stains', 'Day & Night', 'B368/S12578', 'LowFlockDeath', 'Life SkyHigh', 'LowDeath', 'Morley', 'DryLife without Death', 'DryFlock', 'Mazectric with Mice', 'Maze with Mice', 'DryLife', 'Plow World', 'Coagulations', 'Pedestrian Life without Death', 'Pedestrian Flock', 'HoneyFlock', 'Pedestrian Life', 'HoneyLife', 'Electrified Maze', 'Oscillators Rule[11]', 'Walled cities', 'Majority[6]', 'Vote 4/5[12]', 'Lifeguard 1', "Rings 'n' Slugs", 'Vote[12]']

DESCRIPTIONS = ["The black/white reversal of Conway's Game of Life.", "A rule by Jason Rampe, showing similar oscillators and gliders to Conway's Game of Life. The black/white reversal of B3678/S23.", 'A strobing rule witch make spearheaders from chaotic oscillating boundaries.', 'An explosive strobing rule which forms different wickstretchers of different speeds and sizes, mostly accompanied by a "parasite" or patterns that stick to them and change the size of the wicks.', '', '', '', 'A strobing rule which makes mazes that invert themselves each generation (SEIZURE WARNING).', 'A strobing rule in which patterns become neon-like explosive patterns.', 'An exploding rule where H-shaped branches grow from pattern borders.', 'An exploding rule in which solid patterns appear.', 'A simple exploding rule by Kellie Evans that forms complex patterns from even a single live cell.', 'A rule in which patterns explode and form snake-like patterns.', 'A rule in which patterns grow exponentially and form solid patters inside static-like patterns.', 'A rule in which every pattern is a replicator.', 'A rule in which, like Replicator, every pattern is a replicator. Also known as "Replicator 2".', 'An explosive rule where patterns turn into replicators and flash in and out of existence.', "An exploding rule by Brian Silverman in which every cell dies in every generation. It has many simple orthogonal spaceships, though it is in general difficult to create patterns that don't explode.", 'An exploding rule in which only cells with no neighbors survive. It has many spaceships, puffers, and oscillators, some of infinitely extensible size and period.', 'An exploding rule, one of the few B2 life-like rules that has a replicator.', 'An exploding rule, with still lifes that may form indestructible barriers to growth, which can be used as casing for single-use wires, out of which logic gates can be constructed.[2]', 'similar to B2/S2345[3]', 'similar to B2/S2345[4]', 'An exploding rule in which every cell dies in every generation (like Seeds). This rule is of interest because of the fabric-like beauty of the patterns that it produces. Also known as "Persian Rug".', 'An exploding rule, it has a one-dimensional asymmetric replicator.', 'Small masses of solid living cells flicker in and out of existence. Some reach a critical mass and begin to slowly grow. Also known as "Ice nine".', 'An expanding rule that produces complex flakes, featuring dense wickstretchers named "ladder". Also known as "Flakes" or "Inkspot".', "An exploding rule closely related to Conway's Life. The B-heptomino is a common infinite growth pattern in this rule, though it can be stabilized into a spaceship.", '', 'Patterns tend to quickly settle into dominoes, duoplets and period 2 oscillators. There is a common period 14 shuttle oscillator involving the pre-beehive.', 'An expanding rule that crystalizes to form maze-like designs that tend to be straighter (ie. have longer "halls") than the standard maze rule.', 'An expanding rule that crystalizes to form maze-like designs.', 'An explosive rule that is liquid with four types of crystals appearing in the liquid.', '', 'A rule similar to Mazectric but without S3. A slow burn from almost any starting pattern, resulting in a rusting away of the local continuum.', '', '', 'This rule has 6 small still lifes, the tub, the hive, the aircraft carrier, the loaf, the mango, and the pond. However, there are no still lifes with more than 8 and less than 20 cells.[citation needed] There are also a few common oscillators, including the blinker and the toad, and lots of rare ones.', 'A chaotic rule that is by far the most well-known and well-studied. It exhibits highly complex behavior.', '', 'Also known as "Pulsar Life".', 'Shoots are slow growing, well-ordered patterns, while Roots grow faster than shoots, and explosive as they grow.', '', 'An exploding rule in which patterns grow slowly and form coral-like textures.', "An exploding rule that was initially thought to be a stable alternative to Conway's Life, until computer simulation found that most patterns tend to explode. It has many small oscillators and simple period 3 orthogonal and diagonal spaceships.", '', '', 'An explosive rule where patterns slowly form diamond-like shapes and slowly explode.', '', 'A very stable rule that forms permanent diamond-shaped patterns with partially filled interiors. Like in 2×2, patterns made of blocks will permanently remain made of blocks.', 'A stable rule that gets its name from the fact that it has many simple extremely high period oscillators.', 'A rule with "plow" structures that move along an edge of a polygon, increasing its size (turning corners and thickening it as they go), corner-extenders that create these in their wake, and nontrivial interactions based on these (such as a 16-cell methuselah that takes 12127116559 generations to become a period-2 oscillator)[7]', 'An exploding rule with many smaller high-period oscillators and a c/5648 spaceship.', 'An exploding rule with many smaller high-period oscillators and a c/2068 spaceship.', 'A stable rule "one outer-totalistic condition away from Life", where neither of the standard spaceships works, and the most common spaceship is an orthogonal 2c/5 spaceship called "Glider 3736".', 'Expanding chaos organizing itself into plowed fields.', 'An exploding rule explored by Dean Hickerson and David Eppstein.[8]', '', 'An explosive rule where patterns explode while "cheerios" form in the chaotic mess.', 'A self-complementary rule. Black regions are surrounded by froth and tend to eventually collapse starting from the corners, but can be stabilized in various ways by oscillators on their boundaries. c/3, c/4, c/5 and c/7 orthogonal spaceships are known.', 'A chaotic pattern that forms large diamonds with chaotically oscillating boundaries. Known to have quadratically-growing patterns. Like in 2×2, patterns made of blocks will permanently remain made of blocks.', 'A chaotic rule that is well balanced between life and death; it forms patterns with chaotic interiors and wildly moving boundaries.', "A chaotic rule with evolution that resembles Conway's Life, but few patterns from Life work in this rule because the glider is unstable.", 'A very well-balanced and chaotic rule that forms large "continents" of live cells surrounded by chaos at a roughly 50% density, but they eventually erode away into smaller "islands". It is symmetric under on-off reversal.', '', 'A chaotic rule with many simple still lifes, oscillators and spaceships. Its name comes from the fact that it sends patterns made up of 2 × 2 blocks to patterns made up of 2 × 2 blocks.', '', "A chaotic rule very similar to Conway's Life that is of interest because it has a simple replicator.", 'An exploding rule that got confused with Land Rush, likely due to a typo. It does contain a period 4 orthogonal c/2 ship.', 'An exploding rule where the T-tetromino is a blinker puffer, appropriate because it evolves into traffic light in Life, also made of blinkers.', '', 'Name comes from a dirty orthogonal replicator, formerly known as the logarithmic replicator rule.', '', 'A mix between DryLife and HighLife', '', 'A rule where patterns almost explode into castle-like stable patterns.', 'Black/white reversal of InverseLife.', 'A stable rule in which most patterns tend to "fill in" bounded regions. Most nearby rules (such as coagulations) tend to explode.', 'A stable rule that is symmetric under on-off reversal. Many patterns exhibiting highly complex behavior have been found for it.', 'An exploding 2x2-like rule with a small 4c/13o replicator, of which guns and W110 unit cells had been constructed [10]', '', 'A rule that is similar to HighLife but adds a B8 and S6 to the rulestring, hence, the name "SkyHigh".', 'HighLife\'s replicator works in this rule, albeit with a different evolution sequence due to the result of B38/S23\'s "pedestrian" effect.', 'A rule in which random patterns tend to stabilize extremely quickly. Has a very common slow-moving spaceship and slow-moving puffer. Also known as "Move".', '', '', 'Some "mice" run back and forth in the halls of the maze.', 'Similar to B37/S1234, some "mice" run back and forth in the continually-stretching halls of the maze.', "An exploding rule closely related to Conway's Life, named after the fact that standard spaceships bigger than the glider do not function in the rule. Has a small 9c/28 orthogonal puffer based on the R-pentomino, which resembles the switch engine in the possibility of combining several to form a spaceship.", 'An explosive rule, some of the patterns can turn into wickstretchers.', 'An exploding rule in which patterns tend to expand forever, producing a thick "goo" as it does so. Suprisingly, Coagulations actually has one less birth condition than Stains.', '', 'A mix between Pedestrian Life and Flock', '', 'A close Life variant with a number of distinctive natural growth patterns and (5,2)c/190 oblique spaceships.', '', '', 'Random patterns shrink to tiny oscillators, with periods anywhere between 1 ("still lifes") and 16. Larger periods are rare.', 'A stable rule by David Macfarlane that forms centers of pseudo-random activity separated by walls.', '', 'A modification of the standard Gérard Vichniac voting rule, also known as "Anneal", used as a model for majority voting.', '', 'A rule in which patterns stabilize into "Rings" and "Slugs".', 'Standard Gérard Vichniac voting rule, also known as "Majority", used as a model for majority voting.']

class GameOfLife:
    def __init__(self, width, height, cell_size, initial_grid=None, wrap=False, slide_offset=(0,0), rule="B3/S23", proportion=0.25):
        self.width = width
        self.height = height
    ...
    def initialize_random(self):
        self.grid = np.random.choice([0, 1], size=(self.rows, self.cols), p=[1-self.proportion, self.proportion])
    ...
    def draw(self, surface, original_image):
        ...
        if hasattr(self, 'info_text'):
            ...
            for line in self.info_text:
                # Render white text directly onto mask
                text_surface = font.render(line, True, (0, 0, 0))
                image_copy.blit(text_surface, (10, y_offset))
                y_offset += 30
...
class Slideshow:
    ...
    def create_title_image(self, title, captions_list, title_size=72, caption_size=36):
        ...
        title_position = ((self.width - (title_bbox[2]-title_bbox[0])) // 2, 
                          self.height * 2 // 5 - (title_bbox[3]-title_bbox[1]) // 2)
        draw.text(title_position, title, BLACK, font=title_font)

        y_offset = title_position[1] + (title_bbox[3]-title_bbox[1]) * 2
        for caption in captions_list:
            caption_font = ImageFont.truetype("arial.ttf", caption_size)
            caption_bbox = caption_font.getbbox(caption)
            caption_position = ((self.width - (caption_bbox[2]-caption_bbox[0])) // 2, y_offset)
            draw.text(caption_position, caption, BLACK, font=caption_font)
            y_offset += (caption_bbox[3]-caption_bbox[1]) * 1.5
    ...
    def add_slide(self, image, initial_grid=None, wrap=False, cell_size=50, fps=10, paused=False, slide_offset=(0,0), rule="B3/S23", proportion=0.25):
        ...
        if isinstance(image, str):  # If it's a path to an image
            try:
                ...
                self.slides.append((slide, cell_size, initial_grid, wrap, fps, paused, slide_offset, rule, proportion))  # Add as a tuple
            except pygame.error as e:
                print(f"Could not load image: {e}")
        else:  # If it's already a Pygame surface
            self.slides.append((image, cell_size, initial_grid, wrap, fps, paused, slide_offset, rule, proportion))  # Add as a tuple

    def add_slide_pattern(self, image, rle_str, cols=None, rows=None, offset=(0,0), cell_size=50, wrap=False, fps=10, paused=False, slide_offset=(0,0), rule="B3/S23", proportion=0.25):
        pattern = self.parse_rle(rle_str, cols, rows, offset, cell_size, slide_offset)
        self.add_slide(image, pattern, wrap, cell_size, fps, paused, slide_offset, rule, proportion)
    ...
    def initialize_slide(self, slide):
        current_slide, cell_size, initial_grid, wrap, fps, paused, slide_offset, rule, proportion = slide
        if initial_grid is not None:
            # Initialize the Game of Life with a custom grid for this slide
            self.game = GameOfLife(self.width, self.height, cell_size, initial_grid, wrap, slide_offset, rule, proportion)
        else:
            # Initialize the Game of Life with a random grid
            self.game = GameOfLife(self.width, self.height, cell_size, wrap=wrap, slide_offset=slide_offset, rule=rule, proportion=proportion)
        self.paused = paused
    ...
    def run(self):
        ...
        while running:
                ...
                if event.type == pygame.QUIT:
                    ...
                    # Playground controls
                        ...
                        if event.key in (pygame.K_PLUS, pygame.K_EQUALS):
                            current_slide[1] = min(50, current_slide[1] + 2)
                            changed = True
                        elif event.key == pygame.K_MINUS:
                            current_slide[1] = max(4, current_slide[1] - 2)
                            changed = True
                        elif event.key == pygame.K_r:
                            current_slide[7] = RULES[(RULES.index(current_slide[7]) + 1) % len(RULES)]
                            changed = True
                        elif event.key == pygame.K_e:
                            current_slide[7] = RULES[(RULES.index(current_slide[7]) - 1) % len(RULES)]
                            changed = True
                        elif event.key == pygame.K_f:
                            current_slide[4] = min(120, current_slide[4] + 5)
                            changed = True
                        elif event.key == pygame.K_d:
                            current_slide[4] = max(1, current_slide[4] - 5)
                            changed = True
                        elif event.key == pygame.K_v:
                            current_slide[8] = round(min(1, current_slide[8] + 0.05), 2)
                            changed = True
                        elif event.key == pygame.K_c:
                            current_slide[8] = round(max(0, current_slide[8] - 0.05), 2)
                            changed = True
                        elif event.key == pygame.K_q:
                            self.game.grid.fill(0)
                        elif event.key == pygame.K_s:
                            # Generate 10x10 soup with current proportion
                            current_slide_params = self.slides[self.current_slide]
                            proportion = current_slide_params[8]
                            soup = np.random.choice([0, 1], size=(10, 10), p=[1 - proportion, proportion])
                            
                            grid = self.game.grid
                            rows, cols = grid.shape
                            
                            # Calculate centered position
                            start_row = max(0, (rows - 10) // 2)
                            start_col = max(0, (cols - 10) // 2)
                            ...
                            # Update grid section with soup
                            grid[start_row:end_row, start_col:end_col] = soup[:end_row-start_row, :end_col-start_col]
                        
                        if changed:
                            self.slides[self.current_slide] = tuple(current_slide)
                            self.initialize_slide(self.slides[self.current_slide])
            ...
            if self.current_slide == len(self.slides) - 1:  # Playground index
                ...
                cell_size = self.slides[self.current_slide][1]
                proportion = self.slides[self.current_slide][8]
                rule = self.slides[self.current_slide][7]
                
                desc = DESCRIPTIONS[RULES.index(rule)].split(" ")

                # Store text in game object
                self.game.info_text = [
                    "[+/-] Size [R/E] Rule [F/D] FPS [V/C] Proportion [Space] Random [S] Soup [Q] Clear [P] Pause [L] Advance",
                    f"FPS: {current_fps} ({actual_fps:.1f})",
                    f"Cell Size: {cell_size}px",
                    f"Proportion: {proportion}",
                    f"Rule: {rule}, {NAMES[RULES.index(rule)]}",
                ]

                sentence = ""
                for i in range(len(desc)):
                    word = desc[i]
                    if len(word) + len(sentence) < 160:
                        sentence += word + " "
                    else:
                        self.game.info_text.append(sentence)
                        sentence = word + " "
                if sentence != "":
                    self.game.info_text.append(sentence)

            else:
                if hasattr(self.game, 'info_text'):
                    del self.game.info_text
...
2o$4b2o$10bo$6bobo$8bo!
    ...
    # slide 59 - Playground
    slideshow.add_slide(
    slideshow.create_title_image("", []),  # Empty title image
    cell_size=20,
    rule="B3/S23",
    fps=10,
    initial_grid=None,
